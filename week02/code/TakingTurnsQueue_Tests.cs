...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Working as expected.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Persons with an infinite number of turns (turns ≤ 0) will not be re-enqueued and will be removed early. Their turn value will not be saved.
